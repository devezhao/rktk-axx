...
const baseUrl = "https://rk.chinaruankao.com/"; //const baseUrl = 'http://192.168.0.159:8180/rktk/';
...
function z_get(app, url, call) {
    ...
    _my.request({
        ...
        fail: function(res) {
            ...
            console.error(
                "请求失败<GET:" + url + "> - " + JSON.stringify(res || [])
            );
        },
        complete: function() {
            if (loading_timer) {
            ...
            if (loading_show == true) _my.hideLoading();
        }
    });
} // POST 方法
...
function z_post(app, url, data, call) {
    ...
    _my.request({
        ...
        fail: function(res) {
            ...
            console.error(
                "请求失败<POST:" + url + "> - " + JSON.stringify(res || [])
            );
        },
        complete: function() {
            if (loading_timer) {
