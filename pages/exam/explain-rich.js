...
import parse2 from 'mini-html-parser2'
...
_Page({
  data: {
    ...
    hideNos: true,
    questionNodes: [<view>1questionNodes questionNodes questionNodes gfdgfd questionNodes efwfewfewf questionNodes223</view>]
  },
  questionId: null,
  // for share
  qcached: {},
  ...
  onShareAppMessage: function() {
    let d = app.warpShareData(
      "/pages/exam/explain-rich?id=" + this.data.currentQuestionId
    );
    d.title =
      "#考题解析#" +
      this.data.question
