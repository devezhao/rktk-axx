...
_Page({
  ...
  __onLoad: function(e) {
    let that = this;
    that.subjectId = e.id;
    zutils.get(app, "api/subject/details?id=" + that.subjectId, function(
      res
    ) {
      let _data = res.data;
  ...
  toExplain: function(e) {
    ...
    if (this.data.subject_type == 11)
      _url = "../exam/explain-rich?id=" + this.subjectId;
  ...
  onShareAppMessage: function() {
    let d = app.warpShareData(
      "/pages/question/subject?id=" + this.subjectId
    );
