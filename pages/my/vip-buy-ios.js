...
_Page({
    ...
    onLoad: function(e) {
        ...
        let qrcodeUrl =
            "http://wbs.dev.wisecrm.com/qrcode/gen?w=400&t=" +
            encodeURIComponent("https://rktk.statuspage.cn/t/wxx/" + this.__id);
        this.setData({
    ...
    payNow: function() {
        ...
        let that = this;
        zutils.post(app, "api/pay/wxxpay-create?id=" + this.__id, function(
            res
        ) {
            that.setData({
                btnDisabled: false
